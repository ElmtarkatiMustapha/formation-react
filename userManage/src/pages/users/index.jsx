          ...
          {users.map((user) => (
            <tr key={user.id}>
                ...
                <td style={{ display: "flex", gap: "10px" }}>
                  <Button label={'View'} name={'view'} color={'btn-primary'} handleClick={()=>handleViewClick(user.id)}  />
                  <Button label={'Edit'} name={'edit'} color={'btn-warning'} handleClick={()=>handleEditClick(user.id)}  />
                  <Button label={'Delete'} name={'delete'} color={'btn-danger'} handleClick={() => handleDeleteUser(user.id)}  />
                </td>
              </tr>
            ))}
            {users.length === 0 && (
